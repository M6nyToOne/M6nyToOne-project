...
public class ProductController {
    ...
    public ApiResponseDto<ProductResponseDto> getAllProducts(
        ...
        return ApiResponseDto.pagination(HttpStatus.OK, productService.getAllProducts(pageable, productName, category, status) ,"정상적으로 조회 되었습니다");
    }
    ...
    public ApiResponseDto<ProductResponseDto> updateProduct(
        ...
        return ApiResponseDto.success(HttpStatus.OK,productService.updateProduct(userDetails, productId, request));
    }
    ...
    public ApiResponseDto<ProductResponseDto> updateProductStock(
        ...
        return ApiResponseDto.success(
                HttpStatus.OK,
                productService.updateProductStock(userDetails, productId, request.getStock()));
    ...
    public ApiResponseDto<ProductResponseDto> updateProductStatus(
        ...
        return ApiResponseDto.success(
                HttpStatus.OK,
                productService.updateProductStatus(userDetails, productId, request));
    }
